...
export function AITuning() {
    ...
    const handleSaveDraft = async () => {
        ...
        // TODO: API 호출로 드래프트 저장
        await new Promise(r => setTimeout(r, 1000))

        toast.success('드래프트가 저장되었습니다.')
        setIsSaving(false)
    }
    ...
    const handlePublish = async () => {
        ...
        toast.success('프롬프트가 Live 배포되었습니다!')
        setIsSaving(false)
    }
    ...
    /**
     * [Dev Note: Sandbox Test]
     * 프롬프트 수정 후 바로 테스트할 수 있는 채팅창
     * 저장하기 전에 결과 확인 가능
     */
    const handleSandboxSend = async () => {
        ...
        // TODO: 실제 AI 호출 (현재/드래프트 프롬프트 사용)
        await new Promise(r => setTimeout(r, 2000))

        const assistantMessage: ChatMessage = {
            role: 'assistant',
            content: `[${activePrompt?.name} 응답]\n\nLIV-1 분석 결과:\n- 구조 안정성: 87/100\n- 권장 DAR: 4\n- 주요 리스크: 응집 가능성 (중간)\n\n상세 분석이 필요하시면 추가 질문해 주세요.`
        }
    ...
    return (
        <div className="space-y-6">
            ...
            >
                ...
                <p className="text-slate-400 mt-1">AI 에이전트 프롬프트 관리 및 테스트</p>
            </motion.div>
